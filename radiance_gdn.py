...
# Locate the first PREFILL kernel to emit a non-finite value. CHECK above only covers decode, and
# the NaN this fork sees (exactly one head_v-wide head, one TP rank) appears during prefill.
