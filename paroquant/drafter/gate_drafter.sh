...
env MODE=prod SPEC=7 SERVED_NAMES="Qwen3.8 Qwen3.6 Qwen3.8-PARO Qwen3.8-PARO-MXFP4" MODEL_DIR=Qwen3.8-27B-PARO-MXFP4-ft NAME=vllmparomx GPU_UTIL=0.95 \
    CACHE=$HOME/.radiance-cache-paro-mxfp4-093-rs-rs2-sl DRAFTER="$DR" \
...
python3 ~/pibench-local/gsm8k.py --model Qwen3.8-PARO-MXFP4 --tag "drafter-$TAG" --n 500 2>&1 | tail -1 | tee "$OUT/$TAG.gsm8k.log"
